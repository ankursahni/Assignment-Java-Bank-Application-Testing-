...
public class Money implements Comparable {
	...
	public boolean equals(Money other) {
		// @TODO:  Fill in the code for this
		if(this.getUniversalValue() == other.getUniversalValue())
                {
                    return true;
                }
                else
	...
	public boolean isZero() {
		...
		if(this.amount == 0.0)
                {
                    System.out.println("Account Balance is Nil");
                    return true;
                }
                else
                {
	...
	public int compareTo(Object other) {
		// @TODO:  Fill in the code for this
            Money amnt = (Money) other;
            return Double.compare(this.getUniversalValue(), amnt.getUniversalValue());
	}
}
